...
public class BookmarkApiController {
	...
	public ResponseEntity<Void> addBookmark(@AuthenticationPrincipal UserTokenDto dto,
	...
	public ResponseEntity<Void> removeBookmark(@AuthenticationPrincipal UserTokenDto dto,
											   @RequestBody BookmarkRequest bookmarkRequest) throws InterruptedException {
